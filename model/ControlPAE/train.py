...
from .model import ControlMotionPAE
...
if __name__ == "__main__":
    ...
    # initialize model
    mdm_path = './model/ControlDiffusion/lightning_logs/version_0/checkpoints/last.ckpt'
    pae_path = './model/PAE/lightning_logs/version_0/checkpoints/last.ckpt'
    model = ControlMotionPAE(mdm_path, pae_path)
