...
class DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        print(rep_all.shape, discLP_all.shape, LP_weight_all.shape, textemb_all.shape)
        

        # print("max class_index:", torch.amax(class_index_all))    #177
        self.train_dataset = TensorDataset(id_tensor[train_idx], rep_all[train_idx], discLP_all[train_idx], LP_weight_all[train_idx],\
                                           textemb_all[train_idx], masks_tensor[train_idx], progress_tensor[train_idx])
        self.val_dataset = TensorDataset(id_tensor[valid_idx], rep_all[valid_idx], discLP_all[valid_idx], LP_weight_all[valid_idx],\
